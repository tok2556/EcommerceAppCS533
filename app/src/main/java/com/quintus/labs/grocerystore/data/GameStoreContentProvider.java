...
public class GameStoreContentProvider extends ContentProvider {
    // used to access the database
    private GameStoreDatabaseHelper dbHelper;
    ...
    static {
        ...
        uriMatcher.addURI(DatabaseDescription.AUTHORITY,
                UserInfo.TABLE_NAME + "/#", ONE_CONTACT);

        // Uri for Contacts table
        uriMatcher.addURI(DatabaseDescription.AUTHORITY,
                UserInfo.TABLE_NAME, CONTACTS);
    }
    ...
    public boolean onCreate() {
        ...
        dbHelper = new GameStoreDatabaseHelper(getContext());
        ...
        switch (uriMatcher.match(uri)) {
            case ONE_CONTACT: // contact with specified id will be selected
                queryBuilder.appendWhere(
                        UserInfo._ID + "=" + uri.getLastPathSegment());
                break;
        ...
        switch (uriMatcher.match(uri)) {
            case ONE_CONTACT:
                ...
                numberOfRowsUpdated = dbHelper.getWritableDatabase().update(
                        UserInfo.TABLE_NAME, values, UserInfo._ID + "=" + id,
                        selectionArgs);
                break;
            default:
                throw new UnsupportedOperationException(
        ...
        switch (uriMatcher.match(uri)) {
            case ONE_CONTACT:
                ...
                numberOfRowsDeleted = dbHelper.getWritableDatabase().delete(
                        UserInfo.TABLE_NAME, UserInfo._ID + "=" + id, selectionArgs);
                break;
            default:
                throw new UnsupportedOperationException(
